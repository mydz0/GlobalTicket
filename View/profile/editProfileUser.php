...
<body>
    ...
    <main class="edit-main">
        <div class="edit-container">
            ...
            <form class="edit-form" action="/GlobalTicket/View/profile/perfilUser.php" method="get">
                ...
                <div class="edit-btns">
                    ...
                    <!-- form="delete-account-form" links this button to the form above without nesting -->
